...
# ── Нормативная база (актуальные документы РФ) ────────────────────────────
#
# Используются документы, проверенные на актуальность на 2024–2025 гг.:
#
#   Приказ ФСТЭК России №21 от 18.02.2013 (с изм.)
#       — Состав и содержание мер по обеспечению безопасности персональных
#         данных при их обработке в информационных системах персональных данных
#         (применимо к ИСПДн)
#
#   Приказ ФСТЭК России №239 от 25.12.2017 (в ред. Приказа ФСТЭК №213 от 20.02.2023)
#       — Требования по обеспечению безопасности значимых объектов критической
#         информационной инфраструктуры Российской Федерации (применимо к КИИ)
#
#   Приказ ФСТЭК России №31 от 14.03.2014 (с изм. от 09.08.2018, 15.03.2021)
...
#   информации» (утв. 05.02.2021) — обязательный методический документ
#
#   ГОСТ Р 56546-2015 — Защита информации. Уязвимости информационных систем.
#       Классификация уязвимостей информационных систем
#
#   ГОСТ Р 56939-2016 — Защита информации. Разработка безопасного программного
#       обеспечения. Общие требования
#
#   БДУ ФСТЭК России (bdu.fstec.ru) — Банк данных угроз безопасности информации
#
# Все коды мер (АНЗ.*, УПД.*, ИАФ.*, РСБ.*, ОЦЛ.*, ЗТС.*, ЗИС.*) определены
# в составе мер защиты, утверждённом Приказами ФСТЭК №21, №239 и №31.

REGULATORY = {
    "АНЗ.1": {
        "code": "АНЗ.1",
        "title": "Выявление, анализ уязвимостей и оперативное устранение вновь выявленных уязвимостей",
        "primary_doc": "Приказ ФСТЭК России №239 от 25.12.2017 (в ред. от 20.02.2023)",
        "scope": "КИИ; также Приказ №21 (ИСПДн), Приказ №31 (АСУ ТП)",
        "extra_doc": "ГОСТ Р 56546-2015; БДУ ФСТЭК (bdu.fstec.ru)",
    },
    "АНЗ.2": {
        "code": "АНЗ.2",
        ...
        "primary_doc": "Приказ ФСТЭК России №239 от 25.12.2017 (в ред. от 20.02.2023)",
        "scope": "КИИ; также Приказ №21 (ИСПДн), Приказ №31 (АСУ ТП)",
        "extra_doc": "МД ФСТЭК «Методика оценки угроз безопасности информации» (05.02.2021)",
    },
    "УПД.3": {
        "code": "УПД.3",
        "title": "Управление (фильтрация, маршрутизация, контроль соединений) информационными потоками",
        "primary_doc": "Приказ ФСТЭК России №239 от 25.12.2017",
        "scope": "КИИ; также Приказ №21 (ИСПДн), Приказ №31 (АСУ ТП)",
        "extra_doc": "",
    },
    "УПД.13": {
        "code": "УПД.13",
        "title": "Реализация защищённых удалённых сессий доступа к объектам защиты",
        "primary_doc": "Приказ ФСТЭК России №239 от 25.12.2017",
        "scope": "КИИ; также Приказ №21 (ИСПДн)",
        "extra_doc": "",
    },
    "ИАФ.1": {
        "code": "ИАФ.1",
        "title": "Идентификация и аутентификация пользователей, являющихся работниками оператора",
        "primary_doc": "Приказ ФСТЭК России №239 от 25.12.2017",
        "scope": "КИИ; также Приказ №21 (ИСПДн), Приказ №31 (АСУ ТП)",
        "extra_doc": "",
    },
    "ИАФ.3": {
        "code": "ИАФ.3",
        "title": "Управление идентификаторами, в том числе создание, присвоение, уничтожение",
        "primary_doc": "Приказ ФСТЭК России №239 от 25.12.2017",
        "scope": "КИИ; также Приказ №21 (ИСПДн)",
        "extra_doc": "",
    },
    "РСБ.2": {
        "code": "РСБ.2",
        "title": "Определение состава и содержания информации о событиях безопасности, подлежащих регистрации",
        "primary_doc": "Приказ ФСТЭК России №239 от 25.12.2017",
        "scope": "КИИ; также Приказ №21 (ИСПДн), Приказ №31 (АСУ ТП)",
        "extra_doc": "",
    },
    "ОЦЛ.1": {
        "code": "ОЦЛ.1",
        "title": "Контроль целостности программного обеспечения, включая ПО средств защиты информации",
        "primary_doc": "Приказ ФСТЭК России №239 от 25.12.2017",
        "scope": "КИИ; также Приказ №21 (ИСПДн), Приказ №31 (АСУ ТП)",
        "extra_doc": "ГОСТ Р 56939-2016",
    },
    "ОПС.1": {
        "code": "ОПС.1",
        "title": "Разрешение или запрет установки (инсталляции) компонентов программного обеспечения",
        "primary_doc": "Приказ ФСТЭК России №239 от 25.12.2017",
        "scope": "КИИ; также Приказ №21 (ИСПДн)",
        "extra_doc": "",
    },
    "ЗТС.3": {
        "code": "ЗТС.3",
        "title": "Управление конфигурацией объектов защиты и системы защиты информации",
        "primary_doc": "Приказ ФСТЭК России №239 от 25.12.2017",
        "scope": "КИИ; также Приказ №21 (ИСПДн), Приказ №31 (АСУ ТП)",
        "extra_doc": "",
    },
    "ЗИС.3": {
        "code": "ЗИС.3",
        "title": "Обеспечение защиты информации от раскрытия, модификации и навязывания при её передаче",
        "primary_doc": "Приказ ФСТЭК России №239 от 25.12.2017",
        "scope": "КИИ; также Приказ №21 (ИСПДн)",
        "extra_doc": "",
    },
...
def _reg(code: str) -> str:
    ...
    parts = [
        f"{code} — {r.get('title', '')}",
        f"📋 Регулируется: {r.get('primary_doc', '')}",
        f"📌 Область применения: {r.get('scope', '')}",
    ]
    if r.get("extra_doc"):
        parts.append(f"📚 Доп. документы: {r['extra_doc']}")
    return "\n".join(parts)
...
#
# Источник: Методический документ ФСТЭК России «Руководство по организации
# процесса управления уязвимостями в органе (организации)»
# (утверждён ФСТЭК России 17.05.2023).
#
#   Уровень опасности    | CVSS         | Срок устранения
#   ─────────────────────┼──────────────┼─────────────────
#   Критический          | 9.0 – 10.0   | до 24 часов
#   Высокий              | 7.0 –  8.9   | до 7 суток
#   Средний              | 4.0 –  6.9   | до 4 недель  (28 дней)
#   Низкий               | 0.1 –  3.9   | до 4 месяцев (≈120 дней)
#
# Дополнительное условие: для уязвимостей, включённых в БДУ ФСТЭК или CISA KEV
# (то есть активно эксплуатируемых), срок устранения сокращается до 24 часов
# независимо от значения CVSS.

SLA_BY_CVSS = {
    "critical": {"max_days": 1,   "label": "до 24 часов",   "cvss_min": 9.0},
    "high":     {"max_days": 7,   "label": "до 7 суток",    "cvss_min": 7.0},
    "medium":   {"max_days": 28,  "label": "до 4 недель",   "cvss_min": 4.0},
    "low":      {"max_days": 120, "label": "до 4 месяцев",  "cvss_min": 0.0},
}

SLA_KEV = {"max_days": 1, "label": "до 24 часов (активно эксплуатируется)"}

# Регулирующий документ для всех SLA-сроков
SLA_REGULATORY_DOC = (
...
def sla_for(cvss: float, in_kev: bool = False) -> dict:
    """Return SLA dict {max_days, label} aligned with МД ФСТЭК (17.05.2023)."""
    if in_kev:
        return dict(SLA_KEV)
    return dict(SLA_BY_CVSS[cvss_severity(cvss)])
...
def generate(
    ...
    if in_kev:
        recs.append(Recommendation(
            rec_type="urgent",
            title=f"СРОЧНО: уязвимость активно эксплуатируется",
            description=(
                f"{cve_id} включена в каталог активно эксплуатируемых уязвимостей "
                "(CISA KEV / БДУ ФСТЭК) — применяется злоумышленниками в реальных атаках.\n\n"
                "Согласно МД ФСТЭК «Руководство по организации процесса управления "
                "уязвимостями в органе (организации)» (от 17.05.2023): "
                "для уязвимостей, активно используемых в атаках, срок устранения "
                "сокращается до 24 часов независимо от значения CVSS.\n\n"
                "Если патч ещё недоступен — изолируйте хост или отключите уязвимый сервис "
                "до момента обновления."
            ),
            priority=1,
    ...
    recs.append(Recommendation(
        ...
        description=(
            ...
            f"⏱ Срок устранения: {sla}.\n"
            f"Источник: {SLA_REGULATORY_DOC}."
        ),
        priority=pri,
